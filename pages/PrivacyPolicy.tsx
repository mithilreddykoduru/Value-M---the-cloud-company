    ...
    <PageWrapper className="py-20 bg-white">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-gray-500 mt-4">Effective Date: {new Date().toLocaleDateString()}</p>
        </motion.div>
        ...
        >
          ...
          <motion.section variants={sectionVariants}>
            <h2 className="text-xl font-bold text-gray-900 mb-3">10. International Users</h2>
